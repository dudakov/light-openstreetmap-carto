...
@commercial: #ECF0EF;       // Lch(89,8.5,25)
@commercial-line: #E3D9B5;  // Lch(75,12,25)
@industrial: #E9E4E5;       // Lch(89,9,330) (Also used for railway, wastewater_plant)
@industrial-line: #E3D9B5;  // Lch(75,11,330) (Also used for railway-line, wastewater_plant-line)
